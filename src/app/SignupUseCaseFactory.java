...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearUseCase((ClearUserDataAccessInterface) userDataAccessObject, clearViewModel);
    ...
    private static ClearController createClearUseCase(ClearUserDataAccessInterface userDataAccessObject, ClearViewModel clearViewModel) throws IOException {

        ClearOutputBoundary clearPresenter = new ClearPresenter(clearViewModel);

        ClearInputBoundary clearInteractor = new ClearInteractor(
                userDataAccessObject, clearPresenter);
